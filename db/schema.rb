...
ActiveRecord::Schema.define(version: 20160831200621) do
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.index ["invitation_token"], name: "index_customers_on_invitation_token", unique: true, using: :btree
    t.index ["invitations_count"], name: "index_customers_on_invitations_count", using: :btree
    t.index ["invited_by_id"], name: "index_customers_on_invited_by_id", using: :btree
  ...
  create_table "employees", force: :cascade do |t|
    ...
    t.index ["invitations_count"], name: "index_employees_on_invitations_count", using: :btree
    t.index ["invited_by_id"], name: "index_employees_on_invited_by_id", using: :btree
  ...
  create_table "webcams", force: :cascade do |t|
    ...
    t.string  "url"
    t.integer "project_id"
    t.index ["project_id"], name: "index_webcams_on_project_id", using: :btree
  end
